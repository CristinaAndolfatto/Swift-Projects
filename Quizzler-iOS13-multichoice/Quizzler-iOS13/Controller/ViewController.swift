...
class ViewController: UIViewController {
    ...
    // connect to the answer choice buttons
    ...
    override func viewDidLoad() {
        ...
        // set up the answers
        firstChoiceButton.setTitle(quizBrain.getFirstAnswer(), for: .normal)
        secondChoiceButton.setTitle(quizBrain.getSecondAnswer(), for: .normal)
        thirdChoiceButton.setTitle(quizBrain.getThirdAnswer(), for: .normal)
